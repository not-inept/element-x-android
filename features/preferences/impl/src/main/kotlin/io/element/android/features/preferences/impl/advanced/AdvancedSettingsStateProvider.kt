...
open class AdvancedSettingsStateProvider : PreviewParameterProvider<AdvancedSettingsState> {
    override val values: Sequence<AdvancedSettingsState>
        get() = sequenceOf(
            ...
            aAdvancedSettingsState(messageLayout = MessageLayoutOption.Flat),
...
fun aAdvancedSettingsState(
    ...
    messageLayout: MessageLayoutOption = MessageLayoutOption.Bubbles,
    availableMessageLayoutOptions: ImmutableList<MessageLayoutOption> = MessageLayoutOption.entries.toImmutableList(),
    ...
    availableMessageLayoutOptions = availableMessageLayoutOptions,
